...
function dTree(objName, _useCheckBox, _checkBoxName, _downCascading, _upCascading, _singleCheck, _onlyTwigCheckbox) {
	...
	this.icon = {root:"/wxjj/images/dtree_img/base.gif", folder:"/wxjj/images/dtree_img/folder.gif", folderOpen:"/wxjj/images/dtree_img/folderopen.gif", node:"/wxjj/images/dtree_img/page.gif", empty:"/wxjj/images/dtree_img/empty.gif", line:"/wxjj/images/dtree_img/line.gif", join:"/wxjj/images/dtree_img/join.gif", joinBottom:"/wxjj/images/dtree_img/joinbottom.gif", plus:"/wxjj/images/dtree_img/plus.gif", plusBottom:"/wxjj/images/dtree_img/plusbottom.gif", minus:"/wxjj/images/dtree_img/minus.gif", minusBottom:"/wxjj/images/dtree_img/minusbottom.gif", nlPlus:"/wxjj/images/dtree_img/nolines_plus.gif", nlMinus:"/wxjj/images/dtree_img/nolines_minus.gif"};
	this.parEnum = "";
	this.obj = objName;
	this.aNodes = [];
	this.aIndent = [];
...
dTree.prototype.node = function (node, nodeId) {
	...
	if (this.config.useCheckBox && nodeId != 0 && ((this.config.onlyTwigCheckbox && !node._hc) || !this.config.onlyTwigCheckbox)) {
		if (node.pid == 0) {
