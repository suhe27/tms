Validator = {mode:"", Require:/.+/, Email:/^\w+([-+.]\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*$/, Phone:/^((\(\d{2,3}\))|(\d{3}\-))?(\(0\d{2,3}\)|0\d{2,3}-)?[1-9]\d{6,7}(\-\d{1,4})?$/, Msisdn:/^(150|151|152|158|159|188|13[4-9]{1})[0-9]{8}$/, Url:/^http:\/\/[A-Za-z0-9]+\.[A-Za-z0-9]+[\/=\?%\-&_~`@[\]\':+!]*([^<>\"\"])*$/, IdCard:"this.IsIdCard(value)", Currency:/^\d+(\.\d+)?$/, Number:/^\d+$/, Zip:/^[1-9]\d{5}$/, QQ:/^[1-9]\d{4,8}$/, Integer:/^[-\+]?\d+$/,Float2:/^(1|(0(?:(\.{1}[0-9]{0,})|())))$/,
...
MyWindow = {OpenCenterWindow:function (url, name, height, width) {
    ...
    return window.open(url,name,winoption);
}
};
