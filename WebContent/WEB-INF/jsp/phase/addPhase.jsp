...
<div id="div_main"><label class="statictittle">Add Phase</label>
<hr />
<form action="addPhase.action" method="post" onsubmit="return checkPhase();">

<table id="common_table" class="form_table">

	<tr>
		<td class="alignr">Phase Name:</td>
