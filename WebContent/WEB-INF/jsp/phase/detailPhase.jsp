...
<div id="div_main"><label class="statictittle">Phase Detail</label>
<hr />
<form action="updatePhase.action" method="post" onsubmit="return checkPhase();">
