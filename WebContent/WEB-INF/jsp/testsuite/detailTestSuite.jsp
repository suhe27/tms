	...
	<body topmargin="0" leftmargin="0" class="mobile">
		...
		<display:table name="testCaseList" class="mobile" id="row" style="width:100%;"
			...
			<tr  class="pageHeader">
				...
				<th style="width: 32px;" title="Select All">
					<input  name="isSelected" type="checkbox" onclick="selectTestCasesInOneSuite(this);"></input>
				</th>
			...
			<display:column>
			<a href="javascript:showTestCaseClick(${row.testCaseId });" style="color:#0059fd;" title="${row.testCasealiasId }">${row.testCasealiasId }</a>	
			</display:column>
		...
		<div style="width:100%;height:25px;border:1px gray dotted;">
			<div style="float:left;width:45%;height:25px;">
				&nbsp;<input type="button" class="btn" value="Delete" onclick="delTestCaseInTestSuite();"/>
			</div>
