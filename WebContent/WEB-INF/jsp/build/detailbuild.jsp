...
<div id="div_main"><label class="statictittle">BuilType Detail</label>
<hr />
<form action="updateBuild.action" method="post"
	onsubmit="return checkBuild();">
	<input type="text" name="buildId" size="35" readonly="readonly" value="${build.buildId}" style="display:none"/>
<table id="common_table" class="form_table">
	<tr>
		<td width="180px">BuilType Name:</td>
		<td class="alignl"><input type="text" name="buildType" id="buildType" size="35"
			value="${build.buildType}" /></td>
	</tr>
	<tr>
