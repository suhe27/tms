...
<title>Booking Ixias</title>
<script type="text/javascript">
	function selectIxiaClick(id) {
		window.location.href = "toUpdateIxia.action?boardId=" + id;
	}		
</script>
</head>
<body>
...
<table id="common_table" border="1">
	...
	<tr>
		...
		<span style="float:left;"><input type="button" value="Book Boards" onclick="applyBoards();"></input></span>
