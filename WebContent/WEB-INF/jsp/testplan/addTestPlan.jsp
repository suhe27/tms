...
<body>
<form action="addTestPlan.action" method="post"
	onsubmit="return checkTestPlan();">
<table id="common_table" class="form_table">
	<tr>
		<th colspan="2" class="form_head">Add Test Plan</th>
	</tr>
	<tr>
		<td>Plan Name</td>
		<td><input name="testPlan.planName" value="${testPlan.planName}"
			id="planName"><span style="color: red;">*</span></td>
	</tr>
	<tr>
		<td width="150">Project</td>
		<td><select id="projectId" name="testPlan.projectId" onchange="getPhaseList(this.value);">
	...
	<tr>
		...
		<td><input name="testPlan.startDate" id="startDate"
			...
			id="endDate" readonly="readonly"></input><span style="color: red;">*</span>
		</td>
	</tr>
	<tr>
		<td>Descrption</td>
